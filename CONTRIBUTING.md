...
```bash
git clone https://github.com/sablier-labs/docusaurus-plugin-llms.git docusaurus-plugin-llms
cd docusaurus-plugin-llms
bun install
bun setup
```
...
just tsc-build              # Build the TypeScript package
